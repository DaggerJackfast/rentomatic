...
def test_build_file_list_request_object_with_empty_filters():
...
def test_build_file_list_request_object_from_dict_with_invalid_filters():
...
def test_build_file_list_request_object_from_empty_list():
    req = ro.StorageRoomListRequestObject().from_dict({})
